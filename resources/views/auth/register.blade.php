                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control @error('email') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="company_name" type="text" class="form-control @error('email') is-invalid @enderror" name="company_name" value="{{ old('company_name') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone_number" type="text" class="form-control @error('email') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required>
